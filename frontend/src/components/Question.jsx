...
function Question (props) {
  ...
  return (
    <NewWindowBorder>
      <Typography variant='h5'>Question id: {newQid}</Typography>
      <IconButton
        aria-label='expand'
        ...
        <Box sx={{ mt: 0, mb: 2 }}>
          ...
          <Grid container spaceing={1} sx={{ mt: 3 }}>
            <Grid item xs={6} sx={{ pr: 1, pl: 1 }}>
              <Button fullWidth variant='outlined' onClick={addOption}>
                More
              </Button>
            </Grid>
            <Grid item xs={6} sx={{ pr: 1, pl: 1 }}>
              <Button fullWidth variant='outlined' onClick={deleteOption}>
                Delete
              </Button>
            </Grid>
          </Grid>
